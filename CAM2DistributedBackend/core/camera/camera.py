...
class Camera(object):
    ...
    @property
    def resolution_mp(self):
        return self.resolution_width * self.resolution_height / 1000000.0
...
class IPCamera(Camera):
    ...
    def __init__(self, id, ip, image_path, mjpeg_path=None, port=None,
                 latitude=None, longitude=None, resolution_width=None,
                 resolution_height=None, resolution=''):
    ...
    def get_url(self, stream_format=StreamFormat.IMAGE):
        ...
        if self.port is None:
            url = 'http://{}{}{}'.format(self.ip, path, self.resolution)
        else:
            url = 'http://{}:{}{}{}'.format(
                self.ip, self.port, path, self.resolution)
...
class NonIPCamera(Camera):
    ...
    def __init__(self, id, url, latitude=None, longitude=None,
                 resolution_width=None, resolution_height=None):
